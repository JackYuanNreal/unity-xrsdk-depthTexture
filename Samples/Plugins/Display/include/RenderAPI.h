...
public:
	...
	virtual void DrawSimpleTriangles(const float worldMatrix[16], const float projectionMatrix[16], int triangleCount, const void* verticesFloat3Byte4, unsigned int texId, bool doDepthTestWrite) = 0;
